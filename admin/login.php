...
<form name="logForm" method="post" action="?open=Login-Validasi">
  <table class="table-list" width="500" border="0" cellpadding="2" cellspacing="1" bgcolor="#999999">
    <tr>
      <td width="106" rowspan="4" align="center" bgcolor="#CCCCCC"><img src="../images/iconadmin.png" width="116" height="75" /></td>
      <th colspan="2" bgcolor="#CCCCCC"><strong>LOGIN ADMIN</strong></td>      </tr>
    <tr>
